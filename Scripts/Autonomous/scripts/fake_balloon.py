...
class BalloonSimulator(object):
    ...
    def get_background(self, vehicle_roll, vehicle_pitch):
        ...
        top_left1,top_left2 = balloon_utils.rotate_xy(balloon_video.img_center_x-1000, balloon_video.img_center_y, -vehicle_roll) 
        top_right1,top_right2 = balloon_utils.rotate_xy(balloon_video.img_center_x+1000, balloon_video.img_center_y, -vehicle_roll)
        bot_left1,bot_left2 = balloon_utils.rotate_xy(balloon_video.img_center_x-1000,balloon_video.img_center_y+1000, -vehicle_roll)
        bot_right1,bot_right2 = balloon_utils.rotate_xy(balloon_video.img_center_x+1000,balloon_video.img_center_y+1000, -vehicle_roll)
    
        # calculate vertical pixel shift
        pitch_pixel_shift = balloon_video.angle_to_pixels_y(vehicle_pitch)
    
        # add pitch adjustment
        top_left = balloon_utils.shift_pixels_down(top_left1,top_left2, pitch_pixel_shift)
        top_right = balloon_utils.shift_pixels_down(top_right1,top_right2, pitch_pixel_shift)
        bot_left = balloon_utils.shift_pixels_down(bot_left1,bot_left2, pitch_pixel_shift)
        bot_right = balloon_utils.shift_pixels_down(bot_right1,bot_right2, pitch_pixel_shift)
    ...
    def draw_fake_balloon(self, frame, veh_pos, balloon_pos, vehicle_roll, vehicle_pitch, vehicle_yaw):
        ...
        # draw balloon
        cv2.circle(frame,(int(balloon_x),int(balloon_y)), balloon_radius, self.fake_balloon_colour_bgr_scalar, -1)
